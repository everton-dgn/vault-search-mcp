"""
Testes para resolução de paths via config/env.
"""
...
def test_vault_path_uses_env_override(tmp_path, monkeypatch):
    """VAULT_SEARCH_VAULT_PATH deve sobrescrever path do vault."""
    ...
    # Evitar vazamento de estado do módulo para outros testes.
